...
void UpdateComputeDescriptorSet(const ComputeDS *resources)
{
    ...
    Assert(resources->gridCoarseCounts != VK_NULL_HANDLE, "Grid coarse count buffer is not ready");
    ...
    VkDescriptorBufferInfo coarseCounts = {
        .buffer = resources->gridCoarseCounts,
        .offset = 0,
        .range = VK_WHOLE_SIZE,
    };
    ...
    VkWriteDescriptorSet writes[12] = {
        ...
        },
        {
            .sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET,
            .dstSet = GLOBAL.Vulkan.descriptorSet,
            .dstBinding = B_GRID_COARSE_COUNTS,
            .descriptorCount = 1,
            .descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,
            .pBufferInfo = &coarseCounts,
        },
    };
