...
static constexpr uint32_t MaxEnumeratedDeviceExtensions = 1024;
...
static constexpr float cameraFixedDeltaSeconds = 1.0f/240.0f;
static constexpr uint32_t cameraMaxSubstepsPerFrame = 8;
